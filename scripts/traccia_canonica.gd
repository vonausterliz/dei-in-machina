...
const COPIONE := [
	...
	# L'AVANZAMENTO DI TAPPA, e adesso con una CAUSA (R-12). Prima non serviva chiederlo: al
	# quarto turno scattava il tetto e la scena cambiava da sola. Tolto il tetto (R-13) la
